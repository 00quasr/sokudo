...
describe("ThemeProvider", () => {
	...
	describe("high contrast mode", () => {
		...
		it("should work independently of theme setting", async () => {
			vi.mocked(global.fetch).mockResolvedValueOnce({
				ok: true,
				json: async () => ({ theme: "light", highContrast: true }),
			} as Response);
		...
		it("should handle toggling high contrast multiple times", async () => {
			vi.mocked(global.fetch)
				.mockResolvedValueOnce({
					ok: true,
					json: async () => ({ highContrast: false }),
				} as Response)
				.mockResolvedValueOnce({
					ok: true,
